...
const Navbar = () => {
    ...
    return (
        <section className='bg-navbarBlue font-roboto'>
            <div className="container flex justify-between text-white">
                <div className='pt-6 pb-6'>
                    <a href="#">Coffee & Code</a>
                </div>
                ...
                <section id="mobile-menu" className={!nav ? 'fixed right-[-100%]' : 'fixed right-0 top-0 w-[60%] h-full bg-gray-700'}>
